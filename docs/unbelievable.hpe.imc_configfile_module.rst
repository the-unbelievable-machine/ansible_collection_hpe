.. _unbelievable.hpe.imc_configfile_module:


*******************************
unbelievable.hpe.imc_configfile
*******************************
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>File content. Required if state is &quot;present&quot;.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>Folder id of the folder the file is in / should be placed in. Mutually exclusive with folder_name.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>Folder name of the folder the file is in / should be placed in. Mutually exclusive with folder_id.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>present: create or update config file. Requires content.</div>
                        <div>absent: delete config file.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>success</td>
                <td>
                            <div>Id of the file created if state is present. &#x27;check_mode&#x27; if file is running in check mode.</div>
                            <div>Id of the file deleted if state is absent. None if file does not exist.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>success</td>
                <td>
                            <div>If state is absent, this is the same as file_id</div>
                            <div>If state is present, this is the id of replaced file</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>success</td>
                <td>
                            <div>Folder id. Id of the folder the file was placed in.</div>
                    <br/>
                </td>
            </tr>
    </table>
