.. _unbelievable.hpe.imc_configfiles_info_module:


*************************************
unbelievable.hpe.imc_configfiles_info
*************************************
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>Folder id to list content of. Default -1 is the root folder. Mutually exclusive with folder_name.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
                ...
                <td>
                        <div>Folder name to list content of. in / should be placed in. Mutually exclusive with folder_id.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>success</td>
                <td>
                            <div>Folder content. Always present, but may be empty.</div>
                    <br/>
                </td>
            </tr>
            <tr>
                ...
                <td>success</td>
                <td>
                            <div>Folder id that was queried.</div>
                    <br/>
                </td>
            </tr>
    </table>
